# 4 Tjänstedomänens krav och regler - clinicalprocess: healthcond: certificate v4.1-RC1
...
Då tjänster används enligt mönstret fråga-svar från RIVTA 2.1 [R2] synkront är det tjänstekonsumenten som ansvarar för att tolka fel i samband med kommunikationen. Logiska fel behöver hanteras av en tjänstekonsument genom information till användaren, loggning och efterföljande uppföljning. Vid fel av typen INFO kan eventuell text i resultattributet resultText visas för användaren.
