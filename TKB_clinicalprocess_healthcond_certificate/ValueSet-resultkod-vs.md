# Resultatkod — ValueSet - clinicalprocess: healthcond: certificate v4.1-RC1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Resultatkod — ValueSet**

## ValueSet: Resultatkod — ValueSet 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/clinicalprocess-healthcond-certificate/ValueSet/resultkod-vs | *Version*:4.1-RC1 |
| Active as of 2026-09-09 | *Computable Name*:ResultkodVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna resultatkoder för tjänsteanrop. 
...
```json
{
  ...
  "id" : "resultkod-vs",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-healthcond-certificate/ValueSet/resultkod-vs",
  "version" : "4.1-RC1",
  "name" : "ResultkodVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://fhir.inera.se/CodeSystem/resultkod-cs"
    }]
  }
}
