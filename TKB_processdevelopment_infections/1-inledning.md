# 1 Inledning - processdevelopment: infections v1.0.2
...
**Not: källdokumentet för denna domän följer inte den fasta 7-avsnittsmallen som senare TKB:er använder — det saknar separata avsnitt för "Tjänstedomänens arkitektur" och "Gemensamma informationskomponenter", och tjänstekontrakten (avsnitt 4–14 i originalet) ligger direkt på toppnivå istället för samlade under ett enda "Tjänstekontrakt"-avsnitt. Innehållet har mappats om till denna IG:s fasta sidstruktur i möjligaste mån — se avsnitt 3 och 6 för noteringar om detta.**
