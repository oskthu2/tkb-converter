# 6 Gemensamma informationskomponenter - processdevelopment: infections v1.0.2
...
* **Lokala identiteter** (HSA-id + lokalt id, se [4 Tjänstedomänens krav och regler](4-tjanstedomanens-krav-och-regler.md#lokala-identiteter)) — används genomgående för aktivitets-id, tillstånds-id, svars-id, ordinations-id och vårdkontakt-id.
