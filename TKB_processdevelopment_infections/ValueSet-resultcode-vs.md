# ResultCode — ValueSet - processdevelopment: infections v1.0.2
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/processdevelopment-infections/ValueSet/resultcode-vs | *Version*:1.0.2 |
| Active as of 2026-09-17 | *Computable Name*:ResultCodeVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna värden för resultatkod (OK/ERROR/INFO) enligt ResultCodeCS. 
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/processdevelopment-infections/ValueSet/resultcode-vs",
  "version" : "1.0.2",
  "name" : "ResultCodeVS",
