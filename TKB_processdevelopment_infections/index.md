...
```json
{
  ...
  "id" : "inera.processdevelopment-infections",
  "url" : "https://fhir.inera.se/ig/processdevelopment-infections/ImplementationGuide/inera.processdevelopment-infections",
  "version" : "1.0.2",
  "name" : "ProcessdevelopmentInfections",
  ...
  "packageId" : "inera.processdevelopment-infections",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/processdevelopment-infections/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-deleteactivity.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deleteactivity"
      },
      "name" : "DeleteActivity",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-deletecareencounter.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deletecareencounter"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-deletecondition.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deletecondition"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-deletelaboratoryreport.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deletelaboratoryreport"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-deleteprescription.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deleteprescription"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-deleteprescriptionreason.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/deleteprescriptionreason"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processactivity.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processactivity"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processactivity-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processactivity-request"
      },
      "name" : "ProcessActivity — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processcareencounter.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processcareencounter"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processcondition.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processcondition"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processcondition-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processcondition-request"
      },
      "name" : "ProcessCondition — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processlaboratoryreport.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processlaboratoryreport"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processprescriptionreason.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processprescriptionreason"
      },
      "name" : "ProcessPrescriptionReason",
      "description" : "Logisk modell för tjänstekontraktet ProcessPrescriptionReason\n(RIV-TA processdevelopment:infections). Representerar responsens\ninformationsstruktur — bekräftar registrering av en ordinationsorsak.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "description" : "Tillåtna värden för resultatkod (OK/ERROR/INFO) enligt ResultCodeCS.",
      "exampleBoolean" : false
    }],
    "page" : {
      "extension" : [{
