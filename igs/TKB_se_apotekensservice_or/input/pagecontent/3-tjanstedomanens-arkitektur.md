...
*SAKNAS I KÄLLDOKUMENT.* Det finns ingen TKB som beskriver domänens arkitektur. Enligt WSDL-filerna adresseras anropen med SOAP-huvudet `LogicalAddress` och anroparen identifieras med SOAP-huvudet `ArgosHeader` (se [avsnitt 7](7-tjanstekontrakt.html)).
