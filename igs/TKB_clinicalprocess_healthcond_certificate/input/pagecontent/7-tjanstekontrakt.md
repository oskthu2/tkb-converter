...
* **Logisk modell (response):** [StructureDefinition/listcertificatesforcare](StructureDefinition-listcertificatesforcare.html)
* **Logisk modell (request):** [StructureDefinition/listcertificatesforcare-request](StructureDefinition-listcertificatesforcare-request.html)
...
* **Logisk modell (response):** [StructureDefinition/listcertificatesforcitizan](StructureDefinition-listcertificatesforcitizan.html)
* **Logisk modell (request):** [StructureDefinition/listcertificatesforcitizan-request](StructureDefinition-listcertificatesforcitizan-request.html)
...
* **Logisk modell (request):** [StructureDefinition/registercertificate-request](StructureDefinition-registercertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/registercertificate](StructureDefinition-registercertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/revokecertificate-request](StructureDefinition-revokecertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/revokecertificate](StructureDefinition-revokecertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/sendcertificatetorecipient-request](StructureDefinition-sendcertificatetorecipient-request.html)
* **Logisk modell (response):** [StructureDefinition/sendcertificatetorecipient](StructureDefinition-sendcertificatetorecipient.html)
...
* **Logisk modell (request):** [StructureDefinition/sendmessagetocare-request](StructureDefinition-sendmessagetocare-request.html)
* **Logisk modell (response):** [StructureDefinition/sendmessagetocare](StructureDefinition-sendmessagetocare.html)
...
* **Logisk modell (request):** [StructureDefinition/sendmessagetorecipient-request](StructureDefinition-sendmessagetorecipient-request.html)
* **Logisk modell (response):** [StructureDefinition/sendmessagetorecipient](StructureDefinition-sendmessagetorecipient.html)
...
* **Kodsystem (statuskod):** [CodeSystem/statuskod-cs](CodeSystem-statuskod-cs.html)
* **ValueSet (statuskod):** [ValueSet/statuskod-vs](ValueSet-statuskod-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/createdraftcertificate-request](StructureDefinition-createdraftcertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/createdraftcertificate](StructureDefinition-createdraftcertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/certificatestatusupdateforcare-request](StructureDefinition-certificatestatusupdateforcare-request.html)
* **Logisk modell (response):** [StructureDefinition/certificatestatusupdateforcare](StructureDefinition-certificatestatusupdateforcare.html)
* **Kodsystem (händelsekod):** [CodeSystem/handelskod-cs](CodeSystem-handelskod-cs.html)
* **ValueSet (händelsekod):** [ValueSet/handelskod-vs](ValueSet-handelskod-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/listcertificatesforcarewithqa-request](StructureDefinition-listcertificatesforcarewithqa-request.html)
* **Logisk modell (response):** [StructureDefinition/listcertificatesforcarewithqa](StructureDefinition-listcertificatesforcarewithqa.html)
...
* **Logisk modell (request):** [StructureDefinition/listsickleavesforcare-request](StructureDefinition-listsickleavesforcare-request.html)
* **Logisk modell (response):** [StructureDefinition/listsickleavesforcare](StructureDefinition-listsickleavesforcare.html)
