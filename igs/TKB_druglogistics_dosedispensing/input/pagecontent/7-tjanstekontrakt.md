...
* [AvbestallOrginalforpackningRequest](StructureDefinition-avbestallorginalforpackning-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [AvbestallOrginalforpackning](StructureDefinition-avbestallorginalforpackning.html): logisk modell för svaret
...
* [BestallOrginalforpackningRequest](StructureDefinition-bestallorginalforpackning-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [BestallOrginalforpackning](StructureDefinition-bestallorginalforpackning.html): logisk modell för svaret
...
* [HamtaLokaltProduktsortimentRequest](StructureDefinition-hamtalokaltproduktsortiment-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaLokaltProduktsortiment](StructureDefinition-hamtalokaltproduktsortiment.html): logisk modell för svaret
...
* [HamtaMeddelandenRequest](StructureDefinition-hamtameddelanden-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaMeddelanden](StructureDefinition-hamtameddelanden.html): logisk modell för svaret
...
* [HamtaOrginalforpackningRequest](StructureDefinition-hamtaorginalforpackning-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaOrginalforpackning](StructureDefinition-hamtaorginalforpackning.html): logisk modell för svaret
...
* [HamtaVardtagareinformationRequest](StructureDefinition-hamtavardtagareinformation-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaVardtagareinformation](StructureDefinition-hamtavardtagareinformation.html): logisk modell för svaret
...
* [SkapaVardtagareRequest](StructureDefinition-skapavardtagare-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SkapaVardtagare](StructureDefinition-skapavardtagare.html): logisk modell för svaret
...
* [SkickaMeddelandenRequest](StructureDefinition-skickameddelanden-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SkickaMeddelanden](StructureDefinition-skickameddelanden.html): logisk modell för svaret
...
* [SokVardandeEnhetRequest](StructureDefinition-sokvardandeenhet-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SokVardandeEnhet](StructureDefinition-sokvardandeenhet.html): logisk modell för svaret
...
* [UppdateraMeddelandeStatusRequest](StructureDefinition-uppdaterameddelandestatus-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [UppdateraMeddelandeStatus](StructureDefinition-uppdaterameddelandestatus.html): logisk modell för svaret
...
* [UppdateraVardtagareinformationRequest](StructureDefinition-uppdateravardtagareinformation-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [UppdateraVardtagareinformation](StructureDefinition-uppdateravardtagareinformation.html): logisk modell för svaret
