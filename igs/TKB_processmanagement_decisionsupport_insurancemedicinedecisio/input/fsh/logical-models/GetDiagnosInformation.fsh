...
* version 1..1 BackboneElement "Versionsinformation för hela FMB"
* version.senasteVersionsuppdatering 1..1 dateTime "Tidpunkt för senaste versionsuppdatering bland all diagnosinformation"
* version.senasteAndring 1..1 dateTime "Tidpunkt för senaste ändring bland all diagnosinformation"
