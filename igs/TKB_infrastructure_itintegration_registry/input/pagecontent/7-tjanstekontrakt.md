...
_Request-modell: ej skapad som egen logisk modell — requesten innehåller endast två filterfält (`serviceConsumerHsaId`, `serviceContractNameSpace`) som dokumenteras i fältregeltabellen ovan._
...
_Request-modell: ej skapad som egen logisk modell — requesten innehåller endast två filterfält (`serviceConsumerHsaId`, `logicalAdress`) som dokumenteras i fältregeltabellen ovan._
