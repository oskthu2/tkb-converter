...
* **Logisk modell (response):** [StructureDefinition/getrequestactivities](StructureDefinition-getrequestactivities.html)
* **Logisk modell (request):** [StructureDefinition/getrequestactivities-request](StructureDefinition-getrequestactivities-request.html)
* **Kodsystem:** [CodeSystem/kvframstallantyp-cs](CodeSystem-kvframstallantyp-cs.html)
* **ValueSet:** [ValueSet/kvframstallantyp-vs](ValueSet-kvframstallantyp-vs.html)
* **Kodsystem:** [CodeSystem/kvformavframstallan-cs](CodeSystem-kvformavframstallan-cs.html)
* **ValueSet:** [ValueSet/kvformavframstallan-vs](ValueSet-kvformavframstallan-vs.html)
* **Kodsystem:** [CodeSystem/kvstatusvardbegaran-cs](CodeSystem-kvstatusvardbegaran-cs.html)
* **ValueSet:** [ValueSet/kvstatusvardbegaran-vs](ValueSet-kvstatusvardbegaran-vs.html)
