...
// Kontrakt: GetBlocksForPatient v2.0 (querying)
// Genererad: 2026-04-09

Logical: GetBlocksForPatient
Id: getblocksforpatient
Title: "GetBlocksForPatient"
Description: """
  Logisk modell för tjänstekontraktet GetBlocksForPatient
...
* blocks 0..* BackboneElement "Lista över funna aktiva spärrar för angiven patient och vårdgivare"
