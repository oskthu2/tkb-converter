...
// Kontrakt: GetAllBlocksForPatient v2.0 (querying)
// Genererad: 2026-04-09

Logical: GetAllBlocksForPatient
Id: getallblocksforpatient
Title: "GetAllBlocksForPatient"
Description: """
  Logisk modell för tjänstekontraktet GetAllBlocksForPatient
...
* blocks 0..* BackboneElement "Lista över funna aktiva spärrar för angiven patient"
