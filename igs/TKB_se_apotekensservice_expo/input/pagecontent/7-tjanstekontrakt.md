...
* [HamtaApoteksInfoRequest](StructureDefinition-hamtaapoteksinfo-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaApoteksInfo](StructureDefinition-hamtaapoteksinfo.html): logisk modell för svaret
...
* [HamtaApoteksinfoEgetRequest](StructureDefinition-hamtaapoteksinfoeget-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [HamtaApoteksinfoEget](StructureDefinition-hamtaapoteksinfoeget.html): logisk modell för svaret
...
* [KontaktuppgifterHamtaRequest](StructureDefinition-kontaktuppgifterhamta-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [KontaktuppgifterHamta](StructureDefinition-kontaktuppgifterhamta.html): logisk modell för svaret
...
* [KontaktuppgifterUppdateraRequest](StructureDefinition-kontaktuppgifteruppdatera-request.html): logisk modell för begäran, inklusive SOAP-huvudena
...
* [SkapaApotekRequest](StructureDefinition-skapaapotek-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SkapaApotek](StructureDefinition-skapaapotek.html): logisk modell för svaret
...
* [SkapaDosmottagareRequest](StructureDefinition-skapadosmottagare-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SkapaDosmottagare](StructureDefinition-skapadosmottagare.html): logisk modell för svaret
...
* [SokDosmottagareRequest](StructureDefinition-sokdosmottagare-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [SokDosmottagare](StructureDefinition-sokdosmottagare.html): logisk modell för svaret
...
* [TaBortDosmottagareRequest](StructureDefinition-tabortdosmottagare-request.html): logisk modell för begäran, inklusive SOAP-huvudena
...
* [UppdateraDosmottagareRequest](StructureDefinition-uppdateradosmottagare-request.html): logisk modell för begäran, inklusive SOAP-huvudena
...
* [UppdateraExpoMedApotekRequest](StructureDefinition-uppdateraexpomedapotek-request.html): logisk modell för begäran, inklusive SOAP-huvudena
* [UppdateraExpoMedApotek](StructureDefinition-uppdateraexpomedapotek.html): logisk modell för svaret
