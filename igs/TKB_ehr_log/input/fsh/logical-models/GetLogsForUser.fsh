...
// Kontrakt: GetLogsForUser v1.1
// Namnrymd: urn:riv:ehr:log:querying:GetLogsForUserResponder:1
// Genererad: 2026-04-09

Logical: GetLogsForUser
Id: getlogsforuser
Title: "GetLogsForUser"
Description: """
  Logisk modell för tjänstekontraktet GetLogsForUser
