...
Logical: KopplaBarnKontoRequest
Id: kopplabarnkonto-request
Title: "KopplaBarnKonto — Request"
Description: """
  Logisk modell för begäran i KopplaBarnKonto
...
* huvudPersNr 0..1 string "huvudPersNr" "Personnummer för huvudperson (Förmånsmottagare). Anges ej om barnkontot ska kopplas bort från samlingskontot."
...
* persNr 1..1 string "persNr" "Personnummer för den vars konto ska uppdateras."
