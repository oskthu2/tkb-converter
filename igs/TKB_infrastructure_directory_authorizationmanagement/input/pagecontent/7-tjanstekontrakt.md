...
* **Logisk modell (response):** [StructureDefinition/getcredentialsforpersonincludingprotectedperson](StructureDefinition-getcredentialsforpersonincludingprotectedperson.html)
* **Logisk modell (request):** [StructureDefinition/getcredentialsforpersonincludingprotectedperson-request](StructureDefinition-getcredentialsforpersonincludingprotectedperson-request.html)
...
* **Logisk modell (response):** [StructureDefinition/getcredentialsforperson](StructureDefinition-getcredentialsforperson.html)
* **Logisk modell (request):** [StructureDefinition/getcredentialsforperson-request](StructureDefinition-getcredentialsforperson-request.html)
...
* **Logisk modell (response):** [StructureDefinition/getadmincredentialsforpersonincludingprotectedperson](StructureDefinition-getadmincredentialsforpersonincludingprotectedperson.html)
* **Logisk modell (request):** [StructureDefinition/getadmincredentialsforpersonincludingprotectedperson-request](StructureDefinition-getadmincredentialsforpersonincludingprotectedperson-request.html)
...
* **Logisk modell (response):** [StructureDefinition/getadmincredentialsforperson](StructureDefinition-getadmincredentialsforperson.html)
* **Logisk modell (request):** [StructureDefinition/getadmincredentialsforperson-request](StructureDefinition-getadmincredentialsforperson-request.html)
...
| Tjänstekontrakt | Svarstider måste garanteras upp till följande last | Svarstid för 95 % av alla anropen ska ligga inom |
| :--- | :--- | :--- |
...
* **Logisk modell (response):** [StructureDefinition/gethosplastupdate](StructureDefinition-gethosplastupdate.html)
...
* **Logisk modell (response):** [StructureDefinition/gethospcredentialsforperson](StructureDefinition-gethospcredentialsforperson.html)
* **Logisk modell (request):** [StructureDefinition/gethospcredentialsforperson-request](StructureDefinition-gethospcredentialsforperson-request.html)
...
* **Logisk modell (response):** [StructureDefinition/handlehospcertificationperson](StructureDefinition-handlehospcertificationperson.html)
* **Logisk modell (request):** [StructureDefinition/handlehospcertificationperson-request](StructureDefinition-handlehospcertificationperson-request.html)
* **CodeSystem:** [CodeSystem/hosp-operation-cs](CodeSystem-hosp-operation-cs.html)
* **ValueSet:** [ValueSet/hosp-operation-vs](ValueSet-hosp-operation-vs.html)
