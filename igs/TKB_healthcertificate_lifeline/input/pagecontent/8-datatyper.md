...
|---|---|---|---|
| Anmälan mottagen (`AnmalanMottagen`) | JA, NEJ | [lifeline-anmalanmottagen-cs](CodeSystem-lifeline-anmalanmottagen-cs.html) | [lifeline-anmalanmottagen-vs](ValueSet-lifeline-anmalanmottagen-vs.html) |
| Anmälningstyp (`AnmalningsTyp`) | NYANMALD, RATTAD, MAKULERAD | [lifeline-anmalningstyp-cs](CodeSystem-lifeline-anmalningstyp-cs.html) | [lifeline-anmalningstyp-vs](ValueSet-lifeline-anmalningstyp-vs.html) |
| Feltyp (`ErrorIdEnumType`) | VALIDATION_ERROR, TRANSFORMATION_ERROR, APPLICATION_ERROR, TECHNICAL_ERROR | [lifeline-erroridenum-cs](CodeSystem-lifeline-erroridenum-cs.html) | [lifeline-erroridenum-vs](ValueSet-lifeline-erroridenum-vs.html) |
| Barnets kön (`Kon`) | FLICKA, POJKE | [lifeline-kon-cs](CodeSystem-lifeline-kon-cs.html) | [lifeline-kon-vs](ValueSet-lifeline-kon-vs.html) |
| Levande vid födelsen (`Levande`) | JA, NEJ | [lifeline-levande-cs](CodeSystem-lifeline-levande-cs.html) | [lifeline-levande-vs](ValueSet-lifeline-levande-vs.html) |
| Resultatkod (`ResultCodeEnumType`) | OK, ERROR, INFO | [lifeline-resultcodeenum-cs](CodeSystem-lifeline-resultcodeenum-cs.html) | [lifeline-resultcodeenum-vs](ValueSet-lifeline-resultcodeenum-vs.html) |
