...
* **Logisk modell (request):** [StructureDefinition/registermedicalcertificate-request](StructureDefinition-registermedicalcertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/registermedicalcertificate](StructureDefinition-registermedicalcertificate.html)
* **Kodsystem:** [CodeSystem/vardkontakttyp-cs](CodeSystem-vardkontakttyp-cs.html)
* **ValueSet:** [ValueSet/vardkontakttyp-vs](ValueSet-vardkontakttyp-vs.html)
* **Kodsystem:** [CodeSystem/referenstyp-cs](CodeSystem-referenstyp-cs.html)
* **ValueSet:** [ValueSet/referenstyp-vs](ValueSet-referenstyp-vs.html)
* **Kodsystem:** [CodeSystem/aktivitetskod-cs](CodeSystem-aktivitetskod-cs.html)
* **ValueSet:** [ValueSet/aktivitetskod-vs](ValueSet-aktivitetskod-vs.html)
* **Kodsystem:** [CodeSystem/nedsattningsgrad-cs](CodeSystem-nedsattningsgrad-cs.html)
* **ValueSet:** [ValueSet/nedsattningsgrad-vs](ValueSet-nedsattningsgrad-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/receivemedicalcertificatequestion-request](StructureDefinition-receivemedicalcertificatequestion-request.html)
* **Logisk modell (response):** [StructureDefinition/receivemedicalcertificatequestion](StructureDefinition-receivemedicalcertificatequestion.html)
* **Kodsystem:** [CodeSystem/amne-cs](CodeSystem-amne-cs.html)
* **ValueSet:** [ValueSet/amne-vs](ValueSet-amne-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/receivemedicalcertificateanswer-request](StructureDefinition-receivemedicalcertificateanswer-request.html)
* **Logisk modell (response):** [StructureDefinition/receivemedicalcertificateanswer](StructureDefinition-receivemedicalcertificateanswer.html)
...
* **Logisk modell (request):** [StructureDefinition/sendmedicalcertificatequestion-request](StructureDefinition-sendmedicalcertificatequestion-request.html)
* **Logisk modell (response):** [StructureDefinition/sendmedicalcertificatequestion](StructureDefinition-sendmedicalcertificatequestion.html)
...
* **Logisk modell (request):** [StructureDefinition/sendmedicalcertificateanswer-request](StructureDefinition-sendmedicalcertificateanswer-request.html)
* **Logisk modell (response):** [StructureDefinition/sendmedicalcertificateanswer](StructureDefinition-sendmedicalcertificateanswer.html)
...
* **Logisk modell (request):** [StructureDefinition/findallquestions-request](StructureDefinition-findallquestions-request.html)
* **Logisk modell (response):** [StructureDefinition/findallquestions](StructureDefinition-findallquestions.html)
...
* **Logisk modell (request):** [StructureDefinition/findallanswers-request](StructureDefinition-findallanswers-request.html)
* **Logisk modell (response):** [StructureDefinition/findallanswers](StructureDefinition-findallanswers.html)
...
* **Logisk modell (request):** [StructureDefinition/deletequestions-request](StructureDefinition-deletequestions-request.html)
* **Logisk modell (response):** [StructureDefinition/deletequestions](StructureDefinition-deletequestions.html)
...
* **Logisk modell (request):** [StructureDefinition/deleteanswers-request](StructureDefinition-deleteanswers-request.html)
* **Logisk modell (response):** [StructureDefinition/deleteanswers](StructureDefinition-deleteanswers.html)
...
* **Logisk modell (request):** [StructureDefinition/revokemedicalcertificate-request](StructureDefinition-revokemedicalcertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/revokemedicalcertificate](StructureDefinition-revokemedicalcertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/sendmedicalcertificate-request](StructureDefinition-sendmedicalcertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/sendmedicalcertificate](StructureDefinition-sendmedicalcertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/listcertificates-request](StructureDefinition-listcertificates-request.html)
* **Logisk modell (response):** [StructureDefinition/listcertificates](StructureDefinition-listcertificates.html)
* **Kodsystem:** [CodeSystem/status-cs](CodeSystem-status-cs.html)
* **ValueSet:** [ValueSet/status-vs](ValueSet-status-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/getcertificate-request](StructureDefinition-getcertificate-request.html)
* **Logisk modell (response):** [StructureDefinition/getcertificate](StructureDefinition-getcertificate.html)
...
* **Logisk modell (request):** [StructureDefinition/setcertificatestatus-request](StructureDefinition-setcertificatestatus-request.html)
* **Logisk modell (response):** [StructureDefinition/setcertificatestatus](StructureDefinition-setcertificatestatus.html)
