...
![V-MIM — Visa tjänsteval, indata](img_013.png)
...
![V-MIM — Visa möjliga tjänsteutövare, indata](img_010.png)

Utdata (lista):

![V-MIM — Visa möjliga tjänsteutövare, utdata](img_005.png)
...
![V-MIM — Göra tjänsteval, indata](img_003.png)

Utdata:

![V-MIM — Göra tjänsteval, utdata](img_017.png)
...
![V-MIM — Visa listningstyp, utdata](img_014.png)
...
![V-MIM — Visa köstatus, utdata](img_009.png)
