...
// Kontrakt: UpdateBooking v1.1 — Request
// Genererad: 2026-03-24

Logical: UpdateBookingRequest
...
* requestedTimeslot 1..1 BackboneElement "Ny tidsinformation (TimeslotType)"
  ...
  * startTimeInclusive 1..1 string "Startdatum och klockslag (ÅÅÅÅMMDDttmmss)"
      """
      Startdatum och klockslag för ny bokad tid.
      Kardinalitet: Obligatorisk.
      """
  * endTimeExclusive 1..1 string "Slutdatum och klockslag (ÅÅÅÅMMDDttmmss)"
      """
      Slutdatum och klockslag för ny bokad tid.
      Kardinalitet: Obligatorisk.
      """
  ...
  * performer 0..1 Identifier "HSA-id för HoS-person"
      ...
      Kardinalitet: Valfri.
      """
  * bookingId 1..1 string "Bokningsidentitet för bokning att omboka"
      """
      Bokningsidentitet för bokningen som ska ombokas. Måste avse en tidssatt bokning.
      Kardinalitet: Obligatorisk.
      """
  ...
  * careTypeID 0..1 string "Identitet för vårdtyp"
      ...
      Kardinalitet: Valfri.
      """
* subject_of_care_info 0..1 BackboneElement "Invånarinformation (SubjectOfCareType)"
    """
    Invånarens kontaktinformation. Valfri vid ombokning.
    Kardinalitet: Valfri.
    """
  ...
  * lastName 1..1 string "Invånarens efternamn"
      ...
      Kardinalitet: Obligatorisk.
      """
* notification 0..1 string "Avisering"
    """
    Avisering.
    Kardinalitet: Valfri.
    """
