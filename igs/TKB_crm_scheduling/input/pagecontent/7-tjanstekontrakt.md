...
* **Logisk modell (request):** [StructureDefinition/cancelbooking-request](StructureDefinition-cancelbooking-request.html)
* **Logisk modell (response):** [StructureDefinition/cancelbooking](StructureDefinition-cancelbooking.html)
* **Kodsystem:** [CodeSystem/result-code-cs](CodeSystem-result-code-cs.html)
* **ValueSet:** [ValueSet/result-code-vs](ValueSet-result-code-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/getallcaretypes-request](StructureDefinition-getallcaretypes-request.html)
* **Logisk modell (response):** [StructureDefinition/getallcaretypes](StructureDefinition-getallcaretypes.html)
...
* **Logisk modell (request):** [StructureDefinition/getallhealthcarefacilities-request](StructureDefinition-getallhealthcarefacilities-request.html)
* **Logisk modell (response):** [StructureDefinition/getallhealthcarefacilities](StructureDefinition-getallhealthcarefacilities.html)
...
* **Logisk modell (request):** [StructureDefinition/getallperformers-request](StructureDefinition-getallperformers-request.html)
* **Logisk modell (response):** [StructureDefinition/getallperformers](StructureDefinition-getallperformers.html)
...
* **Logisk modell (request):** [StructureDefinition/getalltimetypes-request](StructureDefinition-getalltimetypes-request.html)
* **Logisk modell (response):** [StructureDefinition/getalltimetypes](StructureDefinition-getalltimetypes.html)
...
* **Logisk modell (request):** [StructureDefinition/getavailabledates-request](StructureDefinition-getavailabledates-request.html)
* **Logisk modell (response):** [StructureDefinition/getavailabledates](StructureDefinition-getavailabledates.html)
...
* **Logisk modell (request):** [StructureDefinition/getavailabletimeslots-request](StructureDefinition-getavailabletimeslots-request.html)
* **Logisk modell (response):** [StructureDefinition/getavailabletimeslots](StructureDefinition-getavailabletimeslots.html)
...
* **Logisk modell (request):** [StructureDefinition/getbookingdetails-request](StructureDefinition-getbookingdetails-request.html)
* **Logisk modell (response):** [StructureDefinition/getbookingdetails](StructureDefinition-getbookingdetails.html)
...
* **Logisk modell (request):** [StructureDefinition/getsubjectofcareschedule-request](StructureDefinition-getsubjectofcareschedule-request.html)
* **Logisk modell (response):** [StructureDefinition/getsubjectofcareschedule](StructureDefinition-getsubjectofcareschedule.html)
...
* **Logisk modell (request):** [StructureDefinition/makebooking-request](StructureDefinition-makebooking-request.html)
* **Logisk modell (response):** [StructureDefinition/makebooking](StructureDefinition-makebooking.html)
* **Kodsystem:** [CodeSystem/result-code-cs](CodeSystem-result-code-cs.html)
* **ValueSet:** [ValueSet/result-code-vs](ValueSet-result-code-vs.html)
...
* **Logisk modell (request):** [StructureDefinition/updatebooking-request](StructureDefinition-updatebooking-request.html)
* **Logisk modell (response):** [StructureDefinition/updatebooking](StructureDefinition-updatebooking.html)
* **Kodsystem:** [CodeSystem/result-code-cs](CodeSystem-result-code-cs.html)
* **ValueSet:** [ValueSet/result-code-vs](ValueSet-result-code-vs.html)
