...
## ValueSet: ResultCodeEnum 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/supportprocess-personalresources-interpretation/ValueSet/resultcode-vs | *Version*:1.0.0 |
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/supportprocess-personalresources-interpretation/ValueSet/resultcode-vs",
  "version" : "1.0.0",
  "name" : "ResultCodeVS",
