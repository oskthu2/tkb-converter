# 7 Tjänstekontrakt - supportprocess: personalresources: interpretation — Tolkförmedling v1.0.0
...
* **Logisk modell (begäran):** [StructureDefinition/answerinquiry](StructureDefinition-answerinquiry.md)
* **Logisk modell (svar):** [StructureDefinition/interpretation-result](StructureDefinition-interpretation-result.md)
...
* **Logisk modell (svar):** [StructureDefinition/listbookings](StructureDefinition-listbookings.md)
* **Logisk modell (begäran):** [StructureDefinition/listbookings-request](StructureDefinition-listbookings-request.md)
...
* **Logisk modell (svar):** [StructureDefinition/listinquiries](StructureDefinition-listinquiries.md)
* **Logisk modell (begäran):** [StructureDefinition/listinquiries-request](StructureDefinition-listinquiries-request.md)
...
* **Logisk modell (begäran):** [StructureDefinition/updatebooking](StructureDefinition-updatebooking.md)
* **Logisk modell (svar):** [StructureDefinition/interpretation-result](StructureDefinition-interpretation-result.md)
...
* **Logisk modell (begäran):** [StructureDefinition/createbooking](StructureDefinition-createbooking.md)
* **Logisk modell (svar):** [StructureDefinition/createbooking-response](StructureDefinition-createbooking-response.md)
* **Resultat:** [StructureDefinition/interpretation-result](StructureDefinition-interpretation-result.md)
