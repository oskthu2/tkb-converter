# 5 Tjänstedomänens meddelandemodeller - followup: qualityregistry: nkrr v1.2.2
...
![](images/img_011.jpeg) ProcessRegistrationNotification Modellen är en UML-representation av XSD-schemat. Någon mappning mellan XSD och MIM är därmed inte inkluderad. Nedan beskrivs mappning mellan XSD och informationsmodellen i informationsspecifikationen.
...
![](images/img_009.jpeg) Modellen är en UML-representation av XSD-schemat. Någon mappning mellan XSD och MIM är därmed inte inkluderad. Nedan beskrivs mappning mellan XSD och informationsmodellen i informationsspecifikationen.
...
Datum anges alltid på formatet ”ÅÅÅÅMMDD”, vilket motsvarar ISO 8601-kompatibla formatbeskrivningen ”YYYYMMDD” (se referens [R3]). Tidpunkter anges alltid på formatet ”ÅÅÅÅMMDDttmmss”, vilket motsvarar den ISO 8601-kompatibla formatbeskrivningen ”YYYYMMDDhhmmss” (se referens [R3]).
