...
| Draft as of 2026-09-26 | *Computable Name*:followupqualityregistrynkrr |
...
```json
{
  ...
  "id" : "inera.followup-qualityregistry-nkrr",
  "url" : "https://fhir.inera.se/ig/followup-qualityregistry-nkrr/ImplementationGuide/inera.followup-qualityregistry-nkrr",
  "version" : "1.2.2",
  "name" : "followupqualityregistrynkrr",
  "title" : "followup: qualityregistry: nkrr",
  "status" : "draft",
  "date" : "2026-09-26T19:27:31+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.followup-qualityregistry-nkrr",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/followup-qualityregistry-nkrr/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-getformdata.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getformdata"
      },
      "name" : "GetFormData",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getformdata-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getformdata-request"
      },
      "name" : "GetFormData — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processregistrationnotification.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processregistrationnotification"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processregistrationnotification-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processregistrationnotification-request"
      },
      "name" : "ProcessRegistrationNotification — Request",
