# 1 Inledning - masterdata: organisationalresources: licensetopractice v2.0.0
...
masterdata: organisationalresources: licensetopractice Tjänstekontrakten är baserade på RIVTA 2.1 [R2] och reglerade genom arkitekturella beslut [R1].

### Svenskt namn

underlagförprocesstöd:personella resurser:yrkeslegitimering yrkeslegitimering
