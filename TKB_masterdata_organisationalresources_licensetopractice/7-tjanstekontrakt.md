# 7 Tjänstekontrakt - masterdata: organisationalresources: licensetopractice v2.0.0
...
personId i begäran Om ett personId inte anges i frågan måste ett eller flera av fälten förnamn, efternamn, födelsedatum anges. hospPerson i svar Vid sökning av person med namn och/eller födelsedatum kan resultatet bli 0..* hospPerson. skyddadIdentitet Om personen har skyddad identitet finns endast uppgift om personnummer, födelsedatum, avliden samt en upplysning om att kontakta Socialstyrelsen. Detta gör att konsumenten inte kan använda tjänsten för att kontrollera behörigheter hos en person med skyddad identitet.
...
* **Logisk modell (response):** [StructureDefinition/gethosppersonforpublichealthcare](StructureDefinition-gethosppersonforpublichealthcare.md)
* **Logisk modell (request):** [StructureDefinition/gethosppersonforpublichealthcare-request](StructureDefinition-gethosppersonforpublichealthcare-request.md)
* **Kodsystem (legitimerade yrken):** [CodeSystem/legitimerat-yrke-cs](CodeSystem-legitimerat-yrke-cs.md)
* **ValueSet (legitimerade yrken):** [ValueSet/legitimerat-yrke-vs](ValueSet-legitimerat-yrke-vs.md)
* **Kodsystem (typ av behörighetsbegränsning):** [CodeSystem/typ-av-behorighetsbegransning-cs](CodeSystem-typ-av-behorighetsbegransning-cs.md)
* **ValueSet (typ av behörighetsbegränsning):** [ValueSet/typ-av-behorighetsbegransning-vs](ValueSet-typ-av-behorighetsbegransning-vs.md)
...
personId i begäran Om ett personId inte anges i frågan måste ett eller flera av fälten förnamn, efternamn, födelsedatum anges. hospPerson i svar Vid sökning av person med namn och/eller födelsedatum kan resultatet bli 0..* hospPerson. skyddadIdentitet Om personen har skyddad identitet finns endast uppgift om personnummer, födelsedatum, avliden samt en upplysning om att kontakta Socialstyrelsen. Detta gör att konsumenten inte kan använda tjänsten för att kontrollera behörigheter hos en person med skyddad identitet. Wildcard i sökuttryck '*' eller '%' används för att matcha delar av text. Ex: "apa%" matchar "apan" och "apansson" '?' eller '_' används för att matcha tecken. Ex: "a_a" matchar "apa" och "aba" men inte "apan".
...
* **Logisk modell (response):** [StructureDefinition/gethosppersonforivo](StructureDefinition-gethosppersonforivo.md)
* **Logisk modell (request):** [StructureDefinition/gethosppersonforivo-request](StructureDefinition-gethosppersonforivo-request.md)
* **Kodsystem (kön):** [CodeSystem/kon-cs](CodeSystem-kon-cs.md)
* **ValueSet (kön):** [ValueSet/kon-vs](ValueSet-kon-vs.md)
* **Kodsystem (legitimerade yrken):** [CodeSystem/legitimerat-yrke-cs](CodeSystem-legitimerat-yrke-cs.md)
* **ValueSet (legitimerade yrken):** [ValueSet/legitimerat-yrke-vs](ValueSet-legitimerat-yrke-vs.md)
* **Kodsystem (typ av behörighetsbegränsning):** [CodeSystem/typ-av-behorighetsbegransning-cs](CodeSystem-typ-av-behorighetsbegransning-cs.md)
* **ValueSet (typ av behörighetsbegränsning):** [ValueSet/typ-av-behorighetsbegransning-vs](ValueSet-typ-av-behorighetsbegransning-vs.md)
