...
| Draft as of 2026-09-17 | *Computable Name*:clinicalprocessactivityactions |
...
```json
{
  ...
  "id" : "inera.clinicalprocess-activity-actions",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-activity-actions/ImplementationGuide/inera.clinicalprocess-activity-actions",
  "version" : "1.3",
  "name" : "clinicalprocessactivityactions",
  "title" : "clinicalprocess: activity: actions",
  "status" : "draft",
  "date" : "2026-09-17T11:02:22+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.clinicalprocess-activity-actions",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-activity-actions/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-getactivities.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getactivities"
      },
      "name" : "GetActivities",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getactivities-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getactivities-request"
      },
      "name" : "GetActivities — Request",
