# 7 Tjänstekontrakt - ehr: patientsummary v1.0.0
...
Tabellen är genererad ur tjänsteschemat och visar hela meddelandestrukturen, inklusive EN13606-extraktet. Beskrivningarna är schemats egna annoteringar (engelska) där sådana finns. Typerna beskrivs i [8 Datatyper](8-datatyper.md).
...
* **Logisk modell (request):** [StructureDefinition/getehrextract-request](StructureDefinition-getehrextract-request.md)
* **Logisk modell (response):** [StructureDefinition/getehrextract](StructureDefinition-getehrextract.md)
* **Kodsystem:** [CodeSystem/patientsummary-responsedetailtypecodes-cs](CodeSystem-patientsummary-responsedetailtypecodes-cs.md)
* **ValueSet:** [ValueSet/patientsummary-responsedetailtypecodes-vs](ValueSet-patientsummary-responsedetailtypecodes-vs.md)
...
* **Logisk modell (request):** [StructureDefinition/receiveehrextract-request](StructureDefinition-receiveehrextract-request.md)
* **Logisk modell (response):** [StructureDefinition/receiveehrextract](StructureDefinition-receiveehrextract.md)
...
* **Logisk modell (request):** [StructureDefinition/receiveehrextractstatus-request](StructureDefinition-receiveehrextractstatus-request.md)
* **Logisk modell (response):** [StructureDefinition/receiveehrextractstatus](StructureDefinition-receiveehrextractstatus.md)
* **Kodsystem:** [CodeSystem/patientsummary-responsedetailtypecodes-cs](CodeSystem-patientsummary-responsedetailtypecodes-cs.md)
* **ValueSet:** [ValueSet/patientsummary-responsedetailtypecodes-vs](ValueSet-patientsummary-responsedetailtypecodes-vs.md)
...
| deletion | DeletionType | Innehåller par av rcId och meaning.rcId:Globalt unikt id för posten som ska tas bort. Det värde som skickades då anrop till tjänsten ReceiveEhrExtract gjordes. (Värdet hittas i ”ehr_extract.all_compositions.rc_id”.)meaning:Den huvudinformationstyp som posten (som ska tas bort) gäller för. | 1..* |
...
* **Logisk modell (request):** [StructureDefinition/deleteehrextract-request](StructureDefinition-deleteehrextract-request.md)
* **Logisk modell (response):** [StructureDefinition/deleteehrextract](StructureDefinition-deleteehrextract.md)
...
* **Logisk modell (request):** [StructureDefinition/deleteehrextractstatus-request](StructureDefinition-deleteehrextractstatus-request.md)
* **Logisk modell (response):** [StructureDefinition/deleteehrextractstatus](StructureDefinition-deleteehrextractstatus.md)
* **Kodsystem:** [CodeSystem/patientsummary-responsedetailtypecodes-cs](CodeSystem-patientsummary-responsedetailtypecodes-cs.md)
* **ValueSet:** [ValueSet/patientsummary-responsedetailtypecodes-vs](ValueSet-patientsummary-responsedetailtypecodes-vs.md)
