# ResultCode — ValueSet - ehr: log v1.2.3
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/ehr-log/ValueSet/resultcode-vs | *Version*:1.2.3 |
| Active as of 2026-09-17 | *Computable Name*:ResultCodeVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna statuskoder som kan returneras av tjänsterna i ehr:log-domänen. 
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/ehr-log/ValueSet/resultcode-vs",
  "version" : "1.2.3",
  "name" : "ResultCodeVS",
