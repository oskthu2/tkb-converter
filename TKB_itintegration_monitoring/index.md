...
| Draft as of 2026-09-14 | *Computable Name*:ItintegrationMonitoring |
...
```json
{
  ...
  "id" : "inera.itintegration-monitoring",
  "url" : "https://fhir.inera.se/ig/itintegration-monitoring/ImplementationGuide/inera.itintegration-monitoring",
  "version" : "1",
  "name" : "ItintegrationMonitoring",
  "title" : "itintegration: monitoring",
  "status" : "draft",
  "date" : "2026-09-14T12:53:37+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.itintegration-monitoring",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/itintegration-monitoring/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-pingforconfiguration.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/pingforconfiguration"
      },
