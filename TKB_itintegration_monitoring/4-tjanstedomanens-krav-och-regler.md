# 4 Tjänstedomänens krav och regler - itintegration: monitoring v1
...
Tidpunkter anges i formatet "ÅÅÅÅMMDDttmmss", vilket motsvarar den ISO 8601 och ISO 8824-kompatibla formatbeskrivningen "YYYYMMDDhhmmss".

### Regler (kontraktsspecifika, se även avsnitt 7)

R1: Varje versionshanterad modul/tjänstekomponent som publicerar en eller flera RIVTA 2.1-tjänster (andra tjänstekontrakt än detta) ska exponera en producent för detta tjänstekontrakt.
