...
| Draft as of 2026-09-26 | *Computable Name*:informaticsterminology |
...
```json
{
  ...
  "id" : "inera.informatics-terminology",
  "url" : "https://fhir.inera.se/ig/informatics-terminology/ImplementationGuide/inera.informatics-terminology",
  "version" : "1.4",
  "name" : "informaticsterminology",
  "title" : "informatics: terminology",
  "status" : "draft",
  "date" : "2026-09-26T19:28:21+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.informatics-terminology",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/informatics-terminology/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-getterminologysubset.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getterminologysubset"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getterminologysubset-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getterminologysubset-request"
      },
      "name" : "GetTerminologySubset — Request",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "3-sla-krav-support.html"
        }],
        "nameUrl" : "3-sla-krav-support.html",
        "title" : "3 SLA-krav/support",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "4-tjanstekontrakt.html"
        }],
        "nameUrl" : "4-tjanstekontrakt.html",
        "title" : "4 Tjänstekontrakt",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "5-tillgangliga-urval.html"
        }],
        "nameUrl" : "5-tillgangliga-urval.html",
        "title" : "5 Tillgängliga urval",
        "generation" : "markdown"
      }]
    },
    "parameter" : [{
