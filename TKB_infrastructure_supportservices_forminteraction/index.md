...
| Draft as of 2026-09-26 | *Computable Name*:infrastructuresupportservicesforminteraction |
...
```json
{
  ...
  "id" : "inera.infrastructure-supportservices-forminteraction",
  "url" : "https://fhir.inera.se/ig/infrastructure-supportservices-forminteraction/ImplementationGuide/inera.infrastructure-supportservices-forminteraction",
  "version" : "2.0.0",
  "name" : "infrastructuresupportservicesforminteraction",
  ...
  "packageId" : "inera.infrastructure-supportservices-forminteraction",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/questiontype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/answertype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/infrastructure-supportservices-forminteraction/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "CodeSystem-answertype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/answertype-cs"
      },
      "name" : "AnswerType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-questiontype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/questiontype-cs"
      },
      "name" : "QuestionType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-questiontype-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/questiontype-vs"
      },
      "name" : "QuestionType — ValueSet",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "6-tjanster-sammanstallning.html"
        }],
        "nameUrl" : "6-tjanster-sammanstallning.html",
        "title" : "6 Tjänster sammanställning",
        "generation" : "markdown"
      },
      {
        "extension" : [{
