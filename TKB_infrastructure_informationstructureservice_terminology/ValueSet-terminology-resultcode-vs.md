...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/infrastructure-informationstructureservice-terminology/ValueSet/terminology-resultcode-vs | *Version*:1.0.0 |
...
```json
{
  ...
  "id" : "terminology-resultcode-vs",
  "url" : "https://fhir.inera.se/ig/infrastructure-informationstructureservice-terminology/ValueSet/terminology-resultcode-vs",
  "version" : "1.0.0",
  "name" : "ResultCodeVS",
  "title" : "Resultatkod",
  "status" : "active",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://fhir.inera.se/CodeSystem/terminology-resultcode-cs"
    }]
  }
}
