# 7 Tjänstekontrakt - infrastructure: informationstructureservice: terminology v1.0.0
...
Om en okänd SubsetIdentity skickas in returneras ERROR. I de fall då ett meddelande omfattar LocalOrganizationExtensionId som inte finns returneras INFO. Begrepp som ingår i det gemensamma urvalet hämtas.
...
* **Logisk modell (request):** [StructureDefinition/getterminologysubset-request](StructureDefinition-getterminologysubset-request.md)
* **Logisk modell (response):** [StructureDefinition/getterminologysubset](StructureDefinition-getterminologysubset.md)
* **Kodsystem:** [CodeSystem/terminology-resultcode-cs](CodeSystem-terminology-resultcode-cs.md)
* **ValueSet:** [ValueSet/terminology-resultcode-vs](ValueSet-terminology-resultcode-vs.md)
...
Om endast okända SubsetIdentity skickas in returneras ERROR. I de fall då ett meddelande omfattar flera SubsetIdentity returneras INFO tillsammans med information om vilka identifierare som var felaktiga. Information hämtas för giltiga identifierare.
...
* **Logisk modell (request):** [StructureDefinition/getterminologysubsetinformation-request](StructureDefinition-getterminologysubsetinformation-request.md)
* **Logisk modell (response):** [StructureDefinition/getterminologysubsetinformation](StructureDefinition-getterminologysubsetinformation.md)
* **Kodsystem:** [CodeSystem/terminology-resultcode-cs](CodeSystem-terminology-resultcode-cs.md)
* **ValueSet:** [ValueSet/terminology-resultcode-vs](ValueSet-terminology-resultcode-vs.md)
...
Till denna informationsmängd finns regler som ej uttrycks i schemafilerna och tabellen ovan. Dessa återfinns nedan. Fält 1 - ConceptsResponseThreshold Valfritt värde. Om inget värde anges kan en implementation välja att begränsa max antal returnerade termer.

##### 7.3.3.1 Felhantering

Om en okänd SubsetIdentity skickas in returneras ERROR. Om fler antal begrepp finns än angivet maxantal i svaret returneras INFO. Om fler antal begrepp finns än den största mängd som en viss implementation har som inbyggd maxgräns returneras INFO. I de fall då ett meddelande omfattar LocalOrganizationExtensionId som inte finns returneras INFO. Begrepp som ingår i det gemensamma urvalet hämtas.
...
* **Logisk modell (request):** [StructureDefinition/getconcepts-request](StructureDefinition-getconcepts-request.md)
* **Logisk modell (response):** [StructureDefinition/getconcepts](StructureDefinition-getconcepts.md)
* **Kodsystem:** [CodeSystem/terminology-resultcode-cs](CodeSystem-terminology-resultcode-cs.md)
* **ValueSet:** [ValueSet/terminology-resultcode-vs](ValueSet-terminology-resultcode-vs.md)
