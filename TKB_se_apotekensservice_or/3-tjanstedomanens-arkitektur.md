# 3 Tjänstedomänens arkitektur - se.apotekensservice: or — Ordinationer v7.0.0
...
**SAKNAS I KÄLLDOKUMENT.** Det finns ingen TKB som beskriver domänens arkitektur. Enligt WSDL-filerna adresseras anropen med SOAP-huvudet `LogicalAddress` och anroparen identifieras med SOAP-huvudet `ArgosHeader` (se [avsnitt 7](7-tjanstekontrakt.md)).

### Arkitekturella beslut

Nedan återges domänens dokument med arkitekturella beslut ([AB_se_apotekenservice_or.docx](AB_se_apotekenservice_or.docx), revision PA2, 2017-01-19).
...
Dokumentets innehållsförteckning listar även **2.1 AB: Produktionssättning av domänen utan TKB**, men avsnittet finns inte i dokumentets brödtext. Endast AB-2.2 återges därför nedan.
