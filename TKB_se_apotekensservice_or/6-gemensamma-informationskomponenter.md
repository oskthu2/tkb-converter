# 6 Gemensamma informationskomponenter - se.apotekensservice: or — Ordinationer v7.0.0
...
Domänschema `se.apotekensservice_or_7.0.xsd` (namnrymd `urn:riv:se.apotekensservice:or:7`).
...
Domänschema `se.apotekensservice_or_7_ext_1.2.xsd` (namnrymd `urn:riv:se.apotekensservice:or:7:ext:1`).
...
### HelforpackningsordinationResponse
...
### OrdinationsinformationResponse
...
### OrdinationslistaKortInfoResponse
...
### RegistrerandeApotekspersonalResponse
...
### SenastDispenseratUttagResponse
...
### SenasteHelforpackningsuttagResponse
