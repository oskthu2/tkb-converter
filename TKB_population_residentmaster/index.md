...
| Draft as of 2026-09-17 | *Computable Name*:populationresidentmaster |
...
```json
{
  ...
  "id" : "inera.population-residentmaster",
  "url" : "https://fhir.inera.se/ig/population-residentmaster/ImplementationGuide/inera.population-residentmaster",
  "version" : "1.2",
  "name" : "populationresidentmaster",
  ...
  "packageId" : "inera.population-residentmaster",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/kon-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/avregistreringsorsak-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/avregistreringsorsakkomplett-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/relationstyp-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/relationstatus-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/civilstandkod-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/population-residentmaster/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "CodeSystem-avregistreringsorsak-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/avregistreringsorsak-cs"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-avregistreringsorsakkomplett-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/avregistreringsorsakkomplett-cs"
      },
      "name" : "Avregistreringsorsak (komplett)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-avregistreringsorsakkomplett-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/avregistreringsorsakkomplett-vs"
      },
      "name" : "Avregistreringsorsak (komplett) — ValueSet",
      "description" : "Tillåtna värden för fältet AvregistreringsorsakKodKomplett.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-avregistreringsorsak-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/avregistreringsorsak-vs"
      },
      "name" : "Avregistreringsorsak — ValueSet",
      "description" : "Tillåtna värden för fältet AvregistreringsorsakKod.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-civilstandkod-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/civilstandkod-cs"
      },
      "name" : "Civilståndskod",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-civilstandkod-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/civilstandkod-vs"
      },
      "name" : "Civilståndskod — ValueSet",
      "description" : "Tillåtna värden för fältet CivilstandKod.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-kon-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/kon-cs"
      },
      "name" : "Kön",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-kon-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/kon-vs"
      },
      "name" : "Kön — ValueSet",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-lookupresidentforfullprofile.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/lookupresidentforfullprofile"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-lookupresidentforfullprofile-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/lookupresidentforfullprofile-request"
      },
      "name" : "LookupResidentForFullProfile — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-relationstatus-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/relationstatus-cs"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-relationstatus-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/relationstatus-vs"
      },
      "name" : "Relationsstatus — ValueSet",
      "description" : "Tillåtna värden för fältet Status på en Relation.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-relationstyp-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/relationstyp-cs"
      },
      "name" : "Relationstyp",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-relationstyp-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/relationstyp-vs"
      },
      "name" : "Relationstyp — ValueSet",
