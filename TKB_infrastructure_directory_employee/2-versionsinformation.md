# 2 Versionsinformation - infrastructure: directory: employee v4.0.0
...
GetCommissionMembersIncludingProtectedPerson GetCommissionMembers GetEmployeeIncludingProtectedPerson GetEmployee Nedan redovisas kompatibilitet mellan konsument och producent för tjänstekontrakten som finns i flera versioner. Kompatibilitet avser här såväl format som semantik. För definition av kompatibilitet mellan format, se RIV Tekniska Anvisningar, Översikt.
