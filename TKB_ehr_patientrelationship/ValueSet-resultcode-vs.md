# ResultCode — ValueSet - ehr: patientrelationship v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/ehr-patientrelationship/ValueSet/resultcode-vs | *Version*:1.0.1 |
| Active as of 2026-09-17 | *Computable Name*:ResultCodeVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna svarskoder för tjänstekontrakt i ehr:patientrelationship. 
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/ehr-patientrelationship/ValueSet/resultcode-vs",
  "version" : "1.0.1",
  "name" : "ResultCodeVS",
