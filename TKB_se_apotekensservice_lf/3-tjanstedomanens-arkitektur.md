# 3 Tjänstedomänens arkitektur - se.apotekensservice: lf — Läkemedelsförteckningen för vårdsystem v7.0.0
...
Nedan återges domänens dokument med arkitekturella beslut ([AB_se_apotekenservice_lf.docx](AB_se_apotekenservice_lf.docx), revision PA1, 2017-01-19).
