# 7 Tjänstekontrakt - se.apotekensservice: lf — Läkemedelsförteckningen för vårdsystem v7.0.0
...
* [AterkallaSamtyckeVardsystemRequest](StructureDefinition-aterkallasamtyckevardsystem-request.md): logisk modell för begäran, inklusive SOAP-huvudena
* [AterkallaSamtyckeVardsystem](StructureDefinition-aterkallasamtyckevardsystem.md): logisk modell för svaret
...
* [KontrolleraSamtyckeVardsystemRequest](StructureDefinition-kontrollerasamtyckevardsystem-request.md): logisk modell för begäran, inklusive SOAP-huvudena
* [KontrolleraSamtyckeVardsystem](StructureDefinition-kontrollerasamtyckevardsystem.md): logisk modell för svaret
...
* [LasLFVardsystemRequest](StructureDefinition-laslfvardsystem-request.md): logisk modell för begäran, inklusive SOAP-huvudena
* [LasLFVardsystem](StructureDefinition-laslfvardsystem.md): logisk modell för svaret
...
* [RegistreraSamtyckeVardsystemRequest](StructureDefinition-registrerasamtyckevardsystem-request.md): logisk modell för begäran, inklusive SOAP-huvudena
