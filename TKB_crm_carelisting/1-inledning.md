# 1 Inledning - crm: carelisting v1.0.0
...
> **OBS:** Källdokumentet (RIV_spec_Nationell_Listningsstjänsten.docx) är en informationsspecifikation och saknar den TKB-standardiserade avsnittsnumreringen (avsnitt 1–7). Innehållet har mappats om till standard IG-struktur efter bästa förmåga.
