...
| Draft as of 2026-09-17 | *Computable Name*:crmcarelisting |
...
```json
{
  ...
  "id" : "inera.crm-carelisting",
  "url" : "https://fhir.inera.se/ig/crm-carelisting/ImplementationGuide/inera.crm-carelisting",
  "version" : "1.0.0",
  "name" : "crmcarelisting",
  "title" : "crm: carelisting",
  "status" : "draft",
  "date" : "2026-09-17T11:06:50+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.crm-carelisting",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/personqueuestatus-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/crm-carelisting/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-createlisting.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/createlisting"
      },
      "name" : "CreateListing",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-createlisting-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/createlisting-request"
      },
      "name" : "CreateListing — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getavailablefacilities.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getavailablefacilities"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getavailablefacilities-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getavailablefacilities-request"
      },
      "name" : "GetAvailableFacilities — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlisting.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlisting"
      },
      "name" : "GetListing",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlisting-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlisting-request"
      },
      "name" : "GetListing — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlistingtypes.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlistingtypes"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlistingtypes-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlistingtypes-request"
      },
      "name" : "GetListingTypes — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getpersonqueuestatus.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getpersonqueuestatus"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getpersonqueuestatus-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getpersonqueuestatus-request"
      },
      "name" : "GetPersonQueueStatus — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-personqueuestatus-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/personqueuestatus-cs"
      },
      "name" : "PersonQueueStatus",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-personqueuestatus-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/personqueuestatus-vs"
      },
      "name" : "PersonQueueStatus — ValueSet",
