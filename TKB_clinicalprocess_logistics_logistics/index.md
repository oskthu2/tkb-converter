...
| Draft as of 2026-09-17 | *Computable Name*:clinicalprocesslogisticslogistics |
...
```json
{
  ...
  "id" : "inera.clinicalprocess-logistics-logistics",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-logistics-logistics/ImplementationGuide/inera.clinicalprocess-logistics-logistics",
  "version" : "3.0.13",
  "name" : "clinicalprocesslogisticslogistics",
  ...
  "packageId" : "inera.clinicalprocess-logistics-logistics",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/typeofcareplan-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-logistics-logistics/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-getcarecontacts.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcarecontacts"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcarecontacts-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcarecontacts-request"
      },
      "name" : "GetCareContacts — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcareaplans.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcareaplans"
      },
      "name" : "GetCarePlans",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcareaplans-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcareaplans-request"
      },
      "name" : "GetCarePlans — Request",
