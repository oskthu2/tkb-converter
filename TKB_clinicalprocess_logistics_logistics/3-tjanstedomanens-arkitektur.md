# 3 Tjänstedomänens arkitektur - clinicalprocess: logistics: logistics v3.0.13
...
![](images/img_004.png) **Figur Exempel: Adressering vid anrop till aggregerande tjänst från patienttjänst (t.ex. Journalen).**

![](images/img_007.png) **Figur Exempel: Adressering vid anrop till aggregerande vårdgivartjänst (t.ex. från NPÖ-tillämpningen).**
