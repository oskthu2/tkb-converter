...
| Draft as of 2026-09-17 | *Computable Name*:clinicalprocesshealthcondactoutcome |
...
```json
{
  ...
  "id" : "inera.clinicalprocess-healthcond-actoutcome",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-healthcond-actoutcome/ImplementationGuide/inera.clinicalprocess-healthcond-actoutcome",
  "version" : "4.2.2",
  "name" : "clinicalprocesshealthcondactoutcome",
  ...
  "packageId" : "inera.clinicalprocess-healthcond-actoutcome",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/deliverycode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/examinationstatuscode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/fetalpositioncode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/referraloutcometypecode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/sexcode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/typeofleavecode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/typeofresultcode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-healthcond-actoutcome/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getimagingoutcome.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getimagingoutcome"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getimagingoutcome-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getimagingoutcome-request"
      },
      "name" : "GetImagingOutcome — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlaboratoryorderoutcome.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlaboratoryorderoutcome"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getlaboratoryorderoutcome-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getlaboratoryorderoutcome-request"
      },
      "name" : "GetLaboratoryOrderOutcome — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getmaternitymedicalhistory.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getmaternitymedicalhistory"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getmaternitymedicalhistory-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getmaternitymedicalhistory-request"
      },
      "name" : "GetMaternityMedicalHistory — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getreferraloutcome.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getreferraloutcome"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getreferraloutcome-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getreferraloutcome-request"
      },
      "name" : "GetReferralOutcome — Request",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "5-gemensamma-informationskomponenter.html"
        }],
        "nameUrl" : "5-gemensamma-informationskomponenter.html",
        "title" : "5 Gemensamma informationskomponenter",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "6-tjanstedomanens-meddelandemodeller.html"
        }],
        "nameUrl" : "6-tjanstedomanens-meddelandemodeller.html",
        "title" : "6 Tjänstedomänens meddelandemodeller",
        "generation" : "markdown"
      },
      {
        "extension" : [{
