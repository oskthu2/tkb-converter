# GetObservations - clinicalprocess: healthcond: basic v2.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/clinicalprocess-healthcond-basic/StructureDefinition/getobservations | *Version*:2.0.0 |
| Draft as of 2026-09-09 | *Computable Name*:GetObservations |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-09T16:45:34+00:00",
  "contact" : [{
  ...
  "differential" : {
    ...
    {
      "id" : "getobservations.observations",
      "path" : "getobservations.observations",
    ...
    {
      "id" : "getobservations.observations.header",
      "path" : "getobservations.observations.header",
    ...
    {
      "id" : "getobservations.observations.observationBody",
      "path" : "getobservations.observations.observationBody",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationId",
      "path" : "getobservations.observations.observationBody.observationId",
    ...
    {
      "id" : "getobservations.observations.observationBody.registrationTime",
      "path" : "getobservations.observations.observationBody.registrationTime",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationType",
      "path" : "getobservations.observations.observationBody.observationType",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue",
      "path" : "getobservations.observations.observationBody.observationValue",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.cv",
      "path" : "getobservations.observations.observationBody.observationValue.cv",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.pq",
      "path" : "getobservations.observations.observationBody.observationValue.pq",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.ivlpq",
      "path" : "getobservations.observations.observationBody.observationValue.ivlpq",
      "short" : "Intervall av mätvärden (PQIntervalType, RIV-TA: ivl_pq). Exempelvis 37,1-37,8 °C.",
      "definition" : "Intervall av mätvärden (PQIntervalType, RIV-TA: ivl_pq). Exempelvis 37,1-37,8 °C.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Range"
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.ts",
      "path" : "getobservations.observations.observationBody.observationValue.ts",
      "short" : "Tidpunkt med variabel precision (PartialTimeStampType). Format: ÅÅÅÅMMDDttmmss (varierande precision).",
      "definition" : "Tidpunkt med variabel precision (PartialTimeStampType). Format: ÅÅÅÅMMDDttmmss (varierande precision).",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "string"
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.ivlts",
      "path" : "getobservations.observations.observationBody.observationValue.ivlts",
      "short" : "Tidsintervall med variabel precision (PartialTimePeriodType, RIV-TA: ivl_ts).",
      "definition" : "Tidsintervall med variabel precision (PartialTimePeriodType, RIV-TA: ivl_ts).",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Period"
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.st",
      "path" : "getobservations.observations.observationBody.observationValue.st",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationValue.intValue",
      "path" : "getobservations.observations.observationBody.observationValue.intValue",
      "short" : "Heltal (RIV-TA: int) — för skattningsskalor, ej för fysiskt uppmätta värden.",
      "definition" : "Heltal (RIV-TA: int) — för skattningsskalor, ej för fysiskt uppmätta värden.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "integer"
    ...
    {
      "id" : "getobservations.observations.observationBody.scale",
      "path" : "getobservations.observations.observationBody.scale",
    ...
    {
      "id" : "getobservations.observations.observationBody.observationStatus",
      "path" : "getobservations.observations.observationBody.observationStatus",
    ...
    {
      "id" : "getobservations.observations.observationBody.targetSite",
      "path" : "getobservations.observations.observationBody.targetSite",
    ...
    {
      "id" : "getobservations.observations.observationBody.description",
      "path" : "getobservations.observations.observationBody.description",
    ...
    {
      "id" : "getobservations.observations.observationBody.time",
      "path" : "getobservations.observations.observationBody.time",
    ...
    {
      "id" : "getobservations.observations.observationBody.time.ts",
      "path" : "getobservations.observations.observationBody.time.ts",
      "short" : "Tidpunkt med variabel precision.",
      "definition" : "Tidpunkt med variabel precision.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "string"
    ...
    {
      "id" : "getobservations.observations.observationBody.time.ivlts",
      "path" : "getobservations.observations.observationBody.time.ivlts",
      "short" : "Tidsintervall med variabel precision (RIV-TA: ivl_ts).",
      "definition" : "Tidsintervall med variabel precision (RIV-TA: ivl_ts).",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Period"
    ...
    {
      "id" : "getobservations.observations.observationBody.valueNegation",
      "path" : "getobservations.observations.observationBody.valueNegation",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient",
      "path" : "getobservations.observations.observationBody.patient",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.patientId",
      "path" : "getobservations.observations.observationBody.patient.patientId",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person",
      "path" : "getobservations.observations.observationBody.patient.person",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.personId",
      "path" : "getobservations.observations.observationBody.patient.person.personId",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.givenName",
      "path" : "getobservations.observations.observationBody.patient.person.givenName",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.middleSurname",
      "path" : "getobservations.observations.observationBody.patient.person.middleSurname",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.surname",
      "path" : "getobservations.observations.observationBody.patient.person.surname",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.givenNameMarker",
      "path" : "getobservations.observations.observationBody.patient.person.givenNameMarker",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.gender",
      "path" : "getobservations.observations.observationBody.patient.person.gender",
      "short" : "NI 2017 (Person.kön). KV kön OID: 1.2.752.129.2.2.1.1. Koder: 0 okänt, 1 man, 2 kvinna, 9 ej tillämpligt.",
      "definition" : "NI 2017 (Person.kön). KV kön OID: 1.2.752.129.2.2.1.1. Koder: 0 okänt, 1 man, 2 kvinna, 9 ej tillämpligt.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "CodeableConcept"
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.dateOfBirth",
      "path" : "getobservations.observations.observationBody.patient.person.dateOfBirth",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.confidentialityIndicator",
      "path" : "getobservations.observations.observationBody.patient.person.confidentialityIndicator",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.maritalStatus",
      "path" : "getobservations.observations.observationBody.patient.person.maritalStatus",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.address",
      "path" : "getobservations.observations.observationBody.patient.person.address",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.person.electronicAddress",
      "path" : "getobservations.observations.observationBody.patient.person.electronicAddress",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.address",
      "path" : "getobservations.observations.observationBody.patient.address",
    ...
    {
      "id" : "getobservations.observations.observationBody.patient.electronicAddress",
      "path" : "getobservations.observations.observationBody.patient.electronicAddress",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation",
      "path" : "getobservations.observations.observationBody.participation",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.participantType",
      "path" : "getobservations.observations.observationBody.participation.participantType",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.time",
      "path" : "getobservations.observations.observationBody.participation.time",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.performerId",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.performerId",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.person",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.person",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.jobCode",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.jobCode",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.license",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.license",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.specialistQualification",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.specialistQualification",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.organisation",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.organisation",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.address",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.address",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.healthcareProfessional.electronicAddress",
      "path" : "getobservations.observations.observationBody.participation.healthcareProfessional.electronicAddress",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.patient",
      "path" : "getobservations.observations.observationBody.participation.patient",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.otherPerson",
      "path" : "getobservations.observations.observationBody.participation.otherPerson",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.locationRole",
      "path" : "getobservations.observations.observationBody.participation.locationRole",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.resource",
      "path" : "getobservations.observations.observationBody.participation.resource",
    ...
    {
      "id" : "getobservations.observations.observationBody.participation.organisation",
      "path" : "getobservations.observations.observationBody.participation.organisation",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation",
      "path" : "getobservations.observations.observationBody.relation",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.relationType",
      "path" : "getobservations.observations.observationBody.relation.relationType",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation",
      "path" : "getobservations.observations.observationBody.relation.referredInformation",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation.referenceId",
      "path" : "getobservations.observations.observationBody.relation.referredInformation.referenceId",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation.time",
      "path" : "getobservations.observations.observationBody.relation.referredInformation.time",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation.categorization",
      "path" : "getobservations.observations.observationBody.relation.referredInformation.categorization",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation.informationOwner",
      "path" : "getobservations.observations.observationBody.relation.referredInformation.informationOwner",
    ...
    {
      "id" : "getobservations.observations.observationBody.relation.referredInformation.informationOwner.careGiverId",
      "path" : "getobservations.observations.observationBody.relation.referredInformation.informationOwner.careGiverId",
