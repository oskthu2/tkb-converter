...
![](img_001.png) **Figur 1 Exempel: Adressering vid anrop till aggregerande tjänst från patienttjänst (exempelvis från Journalen).**

![](img_006.png) **Figur 2 Exempel: Adressering vid anrop till aggregerande vårdgivartjänst (exempelvis från Nationell patientöversikt).**

##### Sekvensdiagram för enkel begäran

Siffrorna i diagrammet nedan kopplar ihop begäran-svar för respektive meddelande.

![](img_004.png) Figur 3 Sekvensdiagram över sökning efter information Aggregerade tjänster beskrivs i [R6].
...
![](img_007.png) Figur 5 Sekvensdiagram för komplext flöde.
