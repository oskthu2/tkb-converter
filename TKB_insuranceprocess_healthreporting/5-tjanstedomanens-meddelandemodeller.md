...
![](img_003.png) En del av klasserna i modellen har bedömts ligga utanför V-TIMs tillämpningsområde och har därför inte mappats mot V-TIM. Det gäller klasserna Avsändare, Meddelande, Mottagare samt Organisation.
