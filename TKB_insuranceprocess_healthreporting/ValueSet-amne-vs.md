# Amne — ValueSet - insuranceprocess: healthreporting v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Amne — ValueSet**

## ValueSet: Amne — ValueSet 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/insuranceprocess-healthreporting/ValueSet/amne-vs | *Version*:3.1.0 |
| Active as of 2026-09-14 | *Computable Name*:AmneVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna värden för ämne i fråge/svar-interaktionerna. 
...
```json
{
  ...
  "id" : "amne-vs",
  "url" : "https://fhir.inera.se/ig/insuranceprocess-healthreporting/ValueSet/amne-vs",
  "version" : "3.1.0",
  "name" : "AmneVS",
  "title" : "Amne — ValueSet",
  "status" : "active",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://fhir.inera.se/CodeSystem/amne-cs"
    }]
  }
}
