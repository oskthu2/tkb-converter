# 1 Inledning - processmanagement: decisionsupport: insurancemedicinedecisionsupport v1.0.0
...
Detta är beskrivningen av tjänstekontrakten i tjänstedomänen processmanagement: decisionsupport: insurancemedicinedecisionsupport

Tjänstekontrakten är baserade på RIVTA 2.1 och reglerade genom arkitekturella beslut. Tjänstekontraktsbeskrivningen är en kravspecifikation. Den skall fungera som ett teknikneutralt, formellt regelverk som reglerar integrationskrav för parter (tjänstekonsumenter och tjänsteproducenter) som avser ansluta system för samverkan enligt dessa tjänstekontrakt. Tjänstekontraktsbeskrivningen är också ett viktigt underlag för skapande av de tekniska kontrakten (scheman och WSDL-filer).
...
operativprocesstyrning:beslutsstöd:försäkringsmedicinsktbeslutsstöd försäkringsmedicinsktbeslutsstöd
...
1. Syftet med försäkringsmedicinskt beslutsstöd är att:
