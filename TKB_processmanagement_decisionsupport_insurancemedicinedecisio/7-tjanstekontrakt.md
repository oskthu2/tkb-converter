# 7 Tjänstekontrakt - processmanagement: decisionsupport: insurancemedicinedecisionsupport v1.0.0
...
* **Logisk modell (response):** [StructureDefinition/getfmb](StructureDefinition-getfmb.md)
* **Logisk modell (request):** [StructureDefinition/getfmb-request](StructureDefinition-getfmb-request.md)
...
* **Logisk modell (response):** [StructureDefinition/getdiagnosinformation](StructureDefinition-getdiagnosinformation.md)
* **Logisk modell (request):** [StructureDefinition/getdiagnosinformation-request](StructureDefinition-getdiagnosinformation-request.md)
...
* **Logisk modell (response):** [StructureDefinition/getversions](StructureDefinition-getversions.md)
