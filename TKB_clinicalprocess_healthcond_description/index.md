...
| Draft as of 2026-09-14 | *Computable Name*:clinicalprocesshealthconddescription |
...
```json
{
  ...
  "id" : "inera.clinicalprocess-healthcond-description",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-healthcond-description/ImplementationGuide/inera.clinicalprocess-healthcond-description",
  "version" : "3.0.5",
  "name" : "clinicalprocesshealthconddescription",
  ...
  "packageId" : "inera.clinicalprocess-healthcond-description",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/clinicalprocess-healthcond-description/CodeSystem/assessmentcategory-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/clinicalprocess-healthcond-description/CodeSystem/diagnosistype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-healthcond-description/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getalertinformation.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getalertinformation"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getalertinformation-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getalertinformation-request"
      },
      "name" : "GetAlertInformation — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcaredocumentation.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcaredocumentation"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcaredocumentation-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcaredocumentation-request"
      },
      "name" : "GetCareDocumentation — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getdiagnosis.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getdiagnosis"
      },
      "name" : "GetDiagnosis",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getdiagnosis-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getdiagnosis-request"
      },
      "name" : "GetDiagnosis — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getfunctionalstatus.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getfunctionalstatus"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getfunctionalstatus-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getfunctionalstatus-request"
      },
      "name" : "GetFunctionalStatus — Request",
