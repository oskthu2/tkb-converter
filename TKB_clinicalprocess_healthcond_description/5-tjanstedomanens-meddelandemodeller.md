# 5 Tjänstedomänens meddelandemodeller - clinicalprocess: healthcond: description v3.0.5
...
![](images/img_007.png) Modellen är en UML-representation av XSD-schemat. Någon mappning mellan XSD och MIM är därmed inte inkluderad. Nedan beskrivs mappning mellan MIM/ XSD och informationsmodellen i informationsspecifikationen.
