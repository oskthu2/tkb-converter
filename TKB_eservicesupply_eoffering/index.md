...
| Draft as of 2026-09-26 | *Computable Name*:eservicesupplyeoffering |
...
```json
{
  ...
  "id" : "inera.eservicesupply-eoffering",
  "url" : "https://fhir.inera.se/ig/eservicesupply-eoffering/ImplementationGuide/inera.eservicesupply-eoffering",
  "version" : "1.0.0",
  "name" : "eservicesupplyeoffering",
  "title" : "eservicesupply: eoffering",
  "status" : "draft",
  "date" : "2026-09-26T19:26:39+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.eservicesupply-eoffering",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/securitylevel-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/gender-eoffering-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/eservicesupply-eoffering/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "CodeSystem-gender-eoffering-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/gender-eoffering-cs"
      },
      "name" : "Gender (eOffering)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-gender-eoffering-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/gender-eoffering-vs"
      },
      "name" : "Gender (eOffering) — ValueSet",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getavailableeservices.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getavailableeservices"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-securitylevel-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/securitylevel-cs"
      },
      "name" : "SecurityLevel",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-securitylevel-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/securitylevel-vs"
      },
      "name" : "SecurityLevel — ValueSet",
