# 6 Gemensamma informationskomponenter - druglogistics: dosedispensing — Dosdispensering v1.1.0
...
**SAKNAS I KÄLLDOKUMENT.** Det finns ingen TKB. Objekten och uppräkningarna nedan är återgivna ur dokumentet [Pascal – Objekt och felhantering](Objekt_och_felhantering.pdf) (version 1.5, 2012-03-21), som gränssnittsspecifikationerna i [avsnitt 7](7-tjanstekontrakt.md) hänvisar till som ref[1] (mekanisk konvertering från PDF; vid tveksamhet gäller PDF:en). Motsvarande typer i domänschemat följer efter kodverken.
...
| | | | |
| :--- | :--- | :--- | :--- |
| BestallningsStatusEnum | [Beställningsstatus](CodeSystem-dosedispensing-bestallningsstatus-cs.md) | [BestallningsStatusVS](ValueSet-dosedispensing-bestallningsstatus-vs.md) | 1, 2, 3, 4, 5 |
| BestallningsurvalEnum | [Beställningsurval](CodeSystem-dosedispensing-bestallningsurval-cs.md) | [BestallningsurvalVS](ValueSet-dosedispensing-bestallningsurval-vs.md) | PU, DM, BU, VG |
| IdentitetstypEnum | [Identitetstyp](CodeSystem-dosedispensing-identitetstyp-cs.md) | [IdentitetstypVS](ValueSet-dosedispensing-identitetstyp-vs.md) | P, R, S |
| KommunikationsriktningEnum | [Kommunikationsriktning](CodeSystem-dosedispensing-kommunikationsriktning-cs.md) | [KommunikationsriktningVS](ValueSet-dosedispensing-kommunikationsriktning-vs.md) | 1, 2 |
| MeddelandePrioritetEnum | [Meddelandeprioritet](CodeSystem-dosedispensing-meddelandeprioritet-cs.md) | [MeddelandePrioritetVS](ValueSet-dosedispensing-meddelandeprioritet-vs.md) | L, N, H |
| MeddelandeStatusEnum | [Meddelandestatus](CodeSystem-dosedispensing-meddelandestatus-cs.md) | [MeddelandeStatusVS](ValueSet-dosedispensing-meddelandestatus-vs.md) | L, O, B, BLO, LO, BL |
| MeddelandetypEnum | [Meddelandetyp](CodeSystem-dosedispensing-meddelandetyp-cs.md) | [MeddelandetypVS](ValueSet-dosedispensing-meddelandetyp-vs.md) | OB, PB, FR, MB, VG |
| ResultatkodEnum | [Resultatkod](CodeSystem-dosedispensing-resultatkod-cs.md) | [ResultatkodVS](ValueSet-dosedispensing-resultatkod-vs.md) | 1, 2, 3 |
| VardtagarStatusEnum | [Vårdtagarstatus](CodeSystem-dosedispensing-vardtagarstatus-cs.md) | [VardtagarStatusVS](ValueSet-dosedispensing-vardtagarstatus-vs.md) | 1, 2, 3, 4, 5, 6 |
| YrkesKodEnum | [Yrkeskod](CodeSystem-dosedispensing-yrkeskod-cs.md) | [YrkesKodVS](ValueSet-dosedispensing-yrkeskod-vs.md) | LK, TL, BM, SJ, RS, TH |
