...
| Draft as of 2026-09-17 | *Computable Name*:clinicalprocessactivityprescriptionactoutcome |
...
```json
{
  ...
  "id" : "inera.clinicalprocess-activityprescription-actoutcome",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-activityprescription-actoutcome/ImplementationGuide/inera.clinicalprocess-activityprescription-actoutcome",
  "version" : "2.2.1",
  "name" : "clinicalprocessactivityprescriptionactoutcome",
  ...
  "packageId" : "inera.clinicalprocess-activityprescription-actoutcome",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/errorcode-actoutcome"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/nonreplaceable-actoutcome"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/prescriptionstatus"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/resultcode-actoutcome"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/typeofprescription"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-activityprescription-actoutcome/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getmedicationhistory.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getmedicationhistory"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getmedicationhistory-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getmedicationhistory-request"
      },
      "name" : "GetMedicationHistory — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getvaccinationhistory.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getvaccinationhistory"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getvaccinationhistory-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getvaccinationhistory-request"
      },
      "name" : "GetVaccinationHistory — Request",
