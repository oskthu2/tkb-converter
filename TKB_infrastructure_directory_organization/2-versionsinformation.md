# 2 Versionsinformation - infrastructure: directory: organization v5
...
Följande tjänstekontrakt är oförändrade: GetHealthCareUnit GetHealthCareUnitList GetHealthCareProvider
...
Följande tjänstekontrakt har förändrats. GetHealthCareUnitMembers GetUnit Nedan redovisas kompatibilitet mellan konsument och producent för tjänstekontrakten som finns i flera versioner. Kompatibilitet avser här såväl format som semantik. För definition av kompatibilitet mellan format, se RIV Tekniska Anvisningar, Översikt.
