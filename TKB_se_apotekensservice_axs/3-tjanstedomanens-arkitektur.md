# 3 Tjänstedomänens arkitektur - se.apotekensservice: axs — Hämta patientinformation v7.0.0
...
**SAKNAS I KÄLLDOKUMENT.** Det finns ingen TKB som beskriver domänens arkitektur. Enligt WSDL:en adresseras anropet med SOAP-huvudet `LogicalAddress` satt till organisationsnumret för Apotekens Service AB, och anroparen identifieras med SOAP-huvudet `ArgosHeader` (se [avsnitt 7](7-tjanstekontrakt.md#hamtapatientinfo)).

### Arkitekturella beslut

Nedan återges domänens dokument med arkitekturella beslut ([AB_se_apotekenservice_axs.docx](AB_se_apotekenservice_axs.docx), revision PA1, 2017-01-19).
...
Avvikelsen syns i schemana: tjänsteschemat HamtaPatientInfoResponder 6.0 importerar både domänschema version 4 (`urn:riv:se.apotekensservice:axs:4`) och version 5 (`urn:riv:se.apotekensservice:axs:5`).
