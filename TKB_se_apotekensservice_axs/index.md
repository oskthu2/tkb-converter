# Hem - se.apotekensservice: axs — Hämta patientinformation v7.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/se-apotekensservice-axs/ImplementationGuide/inera.se-apotekensservice-axs | *Version*:7.0.0 |
| Draft as of 2026-09-26 | *Computable Name*:seapotekensserviceaxs |
...
| | | |
| :--- | :--- | :--- |
| [HamtaPatientInfo](7-tjanstekontrakt.md#hamtapatientinfo) | 6.0 | Hämtar patientinformation: eventuellt dosapotek, dosproducent, dosunderlagets status, om det finns aktuella recept samt folkbokförings- och samtyckesinformation |
...
```json
{
  ...
  "id" : "inera.se-apotekensservice-axs",
  "url" : "https://fhir.inera.se/ig/se-apotekensservice-axs/ImplementationGuide/inera.se-apotekensservice-axs",
  "version" : "7.0.0",
  "name" : "seapotekensserviceaxs",
  "title" : "se.apotekensservice: axs — Hämta patientinformation",
  "status" : "draft",
  ...
  "packageId" : "inera.se-apotekensservice-axs",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/axs-dosunderlagstatus-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/axs-folkstatuskod-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/se-apotekensservice-axs/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "ValueSet-axs-dosunderlagstatus-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/axs-dosunderlagstatus-vs"
      },
      "name" : "Dosunderlagets status",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-axs-dosunderlagstatus-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/axs-dosunderlagstatus-cs"
      },
      "name" : "Dosunderlagets status",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-hamtapatientinfo-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/hamtapatientinfo-request"
      },
      "name" : "HamtaPatientInfo — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-hamtapatientinfo.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/hamtapatientinfo"
      },
      "name" : "HamtaPatientInfo — Response",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-axs-folkstatuskod-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/axs-folkstatuskod-vs"
      },
      "name" : "Statuskod för person i FOLK",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-axs-folkstatuskod-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/axs-folkstatuskod-cs"
      },
      "name" : "Statuskod för person i FOLK",
