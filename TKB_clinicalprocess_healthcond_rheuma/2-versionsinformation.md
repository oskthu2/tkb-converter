# 2 Versionsinformation - clinicalprocess: healthcond: rheuma — Reumatismdata v1.0.0
...
Följande nya tjänstekontrakt finns från och med denna version: GetRheumatoidArthritisData, version 1.0
...
> **Obs:** Versionsnumret är inte ifyllt i källdokumentet ("Version …"). Enligt revisionshistoriken och schemat är detta version 1.0 (senaste revision 1.0.RC3).
