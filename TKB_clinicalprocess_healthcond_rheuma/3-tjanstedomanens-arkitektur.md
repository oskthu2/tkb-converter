# 3 Tjänstedomänens arkitektur - clinicalprocess: healthcond: rheuma — Reumatismdata v1.0.0
...
![](img_004.svg) **Figur 1. Exempel: Adressering vid anrop till aggregerande tjänst från patienttjänst (t.ex. från Mina Vårdkontakters tjänst för journalåtkomst)**

![](img_003.svg) **Figur 2. Exempel: Adressering vid anrop till aggregerande vårdgivartjänst (t.ex. från NPÖ-tillämpningen)**
...
![](img_002.png) **Figur 3 Sekvensdiagram över sökning efter reumatismdata.**
