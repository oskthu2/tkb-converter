...
| Draft as of 2026-09-14 | *Computable Name*:ehrAccessControl |
...
```json
{
  ...
  "id" : "inera.ehr-accesscontrol",
  "url" : "https://fhir.inera.se/ig/ehr-accesscontrol/ImplementationGuide/inera.ehr-accesscontrol",
  "version" : "1.0.6",
  "name" : "ehrAccessControl",
  "title" : "ehr:accesscontrol",
  "status" : "draft",
  "date" : "2026-09-14T12:42:20+00:00",
  "publisher" : "Inera AB",
  "contact" : [{
    "name" : "Inera AB",
    "telecom" : [{
  ...
  "packageId" : "inera.ehr-accesscontrol",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/ehr-accesscontrol/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-assertcareengagement.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/assertcareengagement"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-assertcareengagement-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/assertcareengagement-request"
      },
      "name" : "AssertCareEngagement — Request",
