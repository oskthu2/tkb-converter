# 5 Tjänstedomänens meddelandemodeller - infrastructure: itintegration: messagebox v1.0.0
...
| | | | |
| :--- | :--- | :--- | :--- |
| Meddelandestatus (`MessageStatusType`) | RECEIVED, RETRIEVED, DELETED | [messagebox-messagestatus-cs](CodeSystem-messagebox-messagestatus-cs.md) | [messagebox-messagestatus-vs](ValueSet-messagebox-messagestatus-vs.md) |
| Resultatkod (`ResultCodeEnum`) | OK, ERROR, INFO | [messagebox-resultcode-cs](CodeSystem-messagebox-resultcode-cs.md) | [messagebox-resultcode-vs](ValueSet-messagebox-resultcode-vs.md) |
