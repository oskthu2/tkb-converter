# 7 Tjänstekontrakt - infrastructure: itintegration: messagebox v1.0.0
...
Tabellen är genererad ur tjänsteschemat. Typerna beskrivs i [avsnitt 5](5-tjanstedomanens-meddelandemodeller.md).
...
* **Logisk modell (request):** [StructureDefinition/listmessages-request](StructureDefinition-listmessages-request.md)
* **Logisk modell (response):** [StructureDefinition/listmessages](StructureDefinition-listmessages.md)
* **Kodsystem:** [CodeSystem/messagebox-messagestatus-cs](CodeSystem-messagebox-messagestatus-cs.md) (Meddelandestatus)
* **Kodsystem:** [CodeSystem/messagebox-resultcode-cs](CodeSystem-messagebox-resultcode-cs.md) (Resultatkod)
...
* **Logisk modell (request):** [StructureDefinition/getmessages-request](StructureDefinition-getmessages-request.md)
* **Logisk modell (response):** [StructureDefinition/getmessages](StructureDefinition-getmessages.md)
* **Kodsystem:** [CodeSystem/messagebox-messagestatus-cs](CodeSystem-messagebox-messagestatus-cs.md) (Meddelandestatus)
* **Kodsystem:** [CodeSystem/messagebox-resultcode-cs](CodeSystem-messagebox-resultcode-cs.md) (Resultatkod)
...
| result |   |   | 1..1 |
| result.code | string | Information om anropet gick bra(OK, ERROR, INFO) | 1..1 |
| result.errorId | string | Enda möjliga är:1=INTERNAL, 2=UNREAD_DELETE | 0..1 |
| result.errorMessage | string | Text som ytterliggare beskriver felet | 0..1 |
...
* **Logisk modell (request):** [StructureDefinition/deletemessages-request](StructureDefinition-deletemessages-request.md)
* **Logisk modell (response):** [StructureDefinition/deletemessages](StructureDefinition-deletemessages.md)
* **Kodsystem:** [CodeSystem/messagebox-messagestatus-cs](CodeSystem-messagebox-messagestatus-cs.md) (Meddelandestatus)
* **Kodsystem:** [CodeSystem/messagebox-resultcode-cs](CodeSystem-messagebox-resultcode-cs.md) (Resultatkod)
