...
| Draft as of 2026-09-14 | *Computable Name*:itintegrationengagementindex |
...
```json
{
  ...
  "id" : "inera.itintegration-engagementindex",
  "url" : "https://fhir.inera.se/ig/itintegration-engagementindex/ImplementationGuide/inera.itintegration-engagementindex",
  "version" : "1.0.9",
  "name" : "itintegrationengagementindex",
  "title" : "itintegration: engagementindex",
  "status" : "draft",
  "date" : "2026-09-14T12:53:05+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.itintegration-engagementindex",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/itintegration-engagementindex/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-findcontent.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/findcontent"
      },
      "name" : "FindContent",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-findcontent-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/findcontent-request"
      },
      "name" : "FindContent — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processnotification.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processnotification"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processnotification-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processnotification-request"
      },
      "name" : "ProcessNotification — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-update.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/update"
      },
      "name" : "Update",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-update-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/update-request"
      },
      "name" : "Update — Request",
