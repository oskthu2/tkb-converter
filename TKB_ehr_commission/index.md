...
| Draft as of 2026-09-26 | *Computable Name*:ehrcommission |
...
```json
{
  ...
  "id" : "inera.ehr-commission",
  "url" : "https://fhir.inera.se/ig/ehr-commission/ImplementationGuide/inera.ehr-commission",
  "version" : "1.0.0",
  "name" : "ehrcommission",
  "title" : "ehr: commission",
  "status" : "draft",
  "date" : "2026-09-26T19:23:48+00:00",
  "contact" : [{
  ...
  "packageId" : "inera.ehr-commission",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/ehr-commission/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-getcommissionsforperson.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcommissionsforperson"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-getcommissionsforperson-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/getcommissionsforperson-request"
      },
      "name" : "GetCommissionsForPerson — Request",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-setselectedcommissionforperson.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/setselectedcommissionforperson"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-setselectedcommissionforperson-request.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/setselectedcommissionforperson-request"
      },
      "name" : "SetSelectedCommissionForPerson — Request",
