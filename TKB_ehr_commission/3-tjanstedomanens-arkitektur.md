# 3 Tjänstedomänens arkitektur - ehr: commission v1.0.0
...
![](images/img_001.png) **Figur 1 Val av medarbetaruppdrag** När uppdraget är valt kan man gå vidare att autentisera använderen och få ett SAML-intyg med medarbetaruppdrag.
