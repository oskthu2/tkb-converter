# 1 Inledning - clinicalprocess: activityprescription: logistics — Ordinationslogistik v1.0.2
...
> **SAKNAS I KÄLLDOKUMENT — kontrollera manuellt.** Källdokumentet har två figurer här (en ritning och en infogad bild) som inte gick att extrahera ur den gamla .doc-filen (se ASSUME-APL-001).
