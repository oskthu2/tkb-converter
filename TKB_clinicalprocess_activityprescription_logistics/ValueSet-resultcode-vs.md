# ResultCode — ValueSet - clinicalprocess: activityprescription: logistics — Ordinationslogistik v1.0.2
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/clinicalprocess-activityprescription-logistics/ValueSet/resultcode-vs | *Version*:1.0.2 |
| Active as of 2026-09-26 | *Computable Name*:ResultCodeVS |
| **Copyright/Legal**: Copyright 2024 Inera AB. Licensieras under Creative Commons Attribution 4.0. | |

 
Tillåtna värden för resultCode enligt ResultCodeCS. 
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-activityprescription-logistics/ValueSet/resultcode-vs",
  "version" : "1.0.2",
  "name" : "ResultCodeVS",
