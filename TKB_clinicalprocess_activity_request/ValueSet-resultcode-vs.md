...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/clinicalprocess-activity-request/ValueSet/resultcode-vs | *Version*:2.2.0 |
...
```json
{
  ...
  "id" : "resultcode-vs",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-activity-request/ValueSet/resultcode-vs",
  "version" : "2.2.0",
  "name" : "ResultCodeVS",
