# Hem - clinicalprocess: activity: request — Remisshantering v2.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/clinicalprocess-activity-request/ImplementationGuide/inera.clinicalprocess-activity-request | *Version*:2.2.0 |
| Draft as of 2026-09-26 | *Computable Name*:clinicalprocessactivityrequest |
...
FHIR Implementation Guide för tjänstedomänen **clinicalprocess: activity: request** ("Remisshantering") version 2.2. Genererad från Ineras Tjänstekontraktsbeskrivning (TKB).
...
| | | |
| :--- | :--- | :--- |
| [ProcessRequest](7-tjanstekontrakt.md#processrequest) | 2.2 | Skickar en remiss från remittent till remissmottagare |
| [ProcessRequestConfirmation](7-tjanstekontrakt.md#processrequestconfirmation) | 2.2 | Skickar bekräftelse, besked om vidareskickning, kompletteringsbegäran, avbrott eller avvisning till remittenten |
| [ProcessRequestOutcome](7-tjanstekontrakt.md#processrequestoutcome) | 2.2 | Skickar delsvar, preliminärt svar eller slutsvar till remittenten |

Alla tre kontrakten skickar information (push). Den logiska modellen för respektive kontrakt beskriver därför begäran, och svaret beskrivs av den gemensamma modellen [ProcessResult](StructureDefinition-process-result.md).
...
```json
{
  ...
  "id" : "inera.clinicalprocess-activity-request",
  "url" : "https://fhir.inera.se/ig/clinicalprocess-activity-request/ImplementationGuide/inera.clinicalprocess-activity-request",
  "version" : "2.2.0",
  "name" : "clinicalprocessactivityrequest",
  "title" : "clinicalprocess: activity: request — Remisshantering",
  "status" : "draft",
  ...
  "packageId" : "inera.clinicalprocess-activity-request",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/requesttype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/versionreason-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/requestconfirmationtype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/requestoutcometype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/gender-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/telecomtype-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/CodeSystem/errorcode-cs"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/clinicalprocess-activity-request/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-requesttype-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/requesttype-vs"
      },
      "name" : "codeForRequestType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-requesttype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/requesttype-cs"
      },
      "name" : "codeForRequestType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-telecomtype-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/telecomtype-vs"
      },
      "name" : "codeForTelecomType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-telecomtype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/telecomtype-cs"
      },
      "name" : "codeForTelecomType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-requestconfirmationtype-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/requestconfirmationtype-vs"
      },
      "name" : "codeRequestConfirmationType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-requestconfirmationtype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/requestconfirmationtype-cs"
      },
      "name" : "codeRequestConfirmationType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-requestoutcometype-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/requestoutcometype-vs"
      },
      "name" : "codeRequestOutcomeType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-requestoutcometype-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/requestoutcometype-cs"
      },
      "name" : "codeRequestOutcomeType",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-versionreason-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/versionreason-vs"
      },
      "name" : "codeVersionReason",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-versionreason-cs.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/versionreason-cs"
      },
      "name" : "codeVersionReason",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-process-result.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/process-result"
      },
      "name" : "Process* — Svar (ResultType)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processrequest.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processrequest"
      },
      "name" : "ProcessRequest — Remiss (begäran)",
      "description" : "Logisk modell för begäran i ProcessRequest (RIV-TA urn:riv:clinicalprocess:activity:request:ProcessRequestResponder:2, element request av typen RequestType). Remittenten skickar en allmänremiss till remissmottagaren. Svaret är enbart ett resultat, se ProcessResult.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processrequestconfirmation.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processrequestconfirmation"
      },
      "name" : "ProcessRequestConfirmation — Remissbekräftelse (begäran)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-processrequestoutcome.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/processrequestoutcome"
      },
      "name" : "ProcessRequestOutcome — Remissvar (begäran)",
